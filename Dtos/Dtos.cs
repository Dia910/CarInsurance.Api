...
public record ClaimDto(long Id, string ClaimDate, string? Description, decimal Amount);
public record HistoryItemDto(string Type, string Date, string? Description, decimal? Amount, string? Provider);